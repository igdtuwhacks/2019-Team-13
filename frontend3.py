...
window.wm_title("Trainer")

l1=Label(window,text="Name")
l1.grid(row=0,column=0)

l2=Label(window,text="Email ID")
l2.grid(row=0,column=2)

l3=Label(window,text="Password")
l3.grid(row=1,column=0)

l4=Label(window,text="Organisation")
l4.grid(row=1,column=2)

l5=Label(window,text="Qualifications")
l5.grid(row=2,column=0)

l6=Label(window,text="Preffered Subject")
l6.grid(row=2,column=2)

l7=Label(window,text="Preffered Semester")
l7.grid(row=3,column=0)

l8=Label(window,text="Paytm UPI")
l8.grid(row=3,column=2)

l9=Label(window,text="Age")
l9.grid(row=4,column=0)

l10=Label(window,text="Link to Study Material ")
l10.grid(row=4,column=2)

l11=Label(window,text="Link to Assignments")
l11.grid(row=5,column=0)

l10=Label(window,text="Link to Cummulative Marksheet")
