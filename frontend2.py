...
l5=Label(window,text="SSN/ Aadhar Number")
l5.grid(row=2,column=0)

l6=Label(window,text="School/Organisation")
l6.grid(row=2,column=2)

l7=Label(window,text="Address")
l7.grid(row=3,column=0)

l8=Label(window,text="Opted Programme 1")
l8.grid(row=3,column=2)

l9=Label(window,text="Opted Programme 2")
l9.grid(row=4,column=0)

l10=Label(window,text="Opted Programme 3")
l10.grid(row=4,column=2)

l11=Label(window,text="Opted Programme 4")
l11.grid(row=5,column=0)

l10=Label(window,text="Opted Programme 5")
